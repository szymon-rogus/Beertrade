...
export const APP_TITLE = "Beertrade"
export const beerPhoto =
...
export const snackBar = (message, color) => Snackbar.show({
  text: message,
...
export const getErrorMessage = (error) => {
  if(error.response) {
    snackBar(error.response.data, "red")
  } else {
    snackBar(NETWORK_ERROR, "red")
  }
}
