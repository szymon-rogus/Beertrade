...
class PricesAmorthizedModifierWithDistributionImpl[I](borderPrices: Map[I, BorderPrices]) extends AbstractBucketsPricesModifier[I] {
...
object PricesAmorthizedModifierWithDistributionImpl {
  def apply[I](borderPrices: Map[I, BorderPrices]): Option[PricesAmorthizedModifierWithDistributionImpl[I]] = {
    if (validateBorderPrices(borderPrices))
      Option(new PricesAmorthizedModifierWithDistributionImpl(borderPrices))
    else
      None
  }
